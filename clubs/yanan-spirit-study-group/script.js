...
(function () {
  ...
  if (lightbox && lightboxImg) {
    document.querySelectorAll('.gallery-thumb, .honor-card').forEach(function (item) {
  ...
  var fadeTargets = document.querySelectorAll(
    '.section-header, .about-text, .about-sidebar, .dept-card, .gallery-thumb, .activity-card, .honor-card, .honors-note'
  );
